...
class EventBuilder:
    ...
    async def build(
        ...
        if format_version == EventFormatVersions.V1:
            ...
            auth_events: Union[List[str], List[Tuple[str, Dict[str, str]]]] = await self._store.add_event_hashes(
                auth_event_ids
            )
            prev_events: Union[List[str], List[Tuple[str, Dict[str, str]]]] = await self._store.add_event_hashes(
                prev_event_ids
            )
        else:
