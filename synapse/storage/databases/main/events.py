...
class PersistEventsStore:
    ...
    def _update_room_depths_txn(
        ...
        for event, context in events_and_contexts:
            ...
            txn.call_after(self.store._invalidate_async_get_event_cache, event.event_id)
            txn.call_after(self.store._invalidate_local_get_event_cache, event.event_id)
    ...
    def _store_redaction(self, txn: LoggingTransaction, event: EventBase) -> None:
        ...
        txn.call_after(self.store._invalidate_async_get_event_cache, event.redacts)
        txn.call_after(self.store._invalidate_local_get_event_cache, event.redacts)
