...
CREATE TABLE IF NOT EXISTS registration_tokens(
    ...
    total_uses INT,  -- The total number of times this token can be used. NULL if no limit.
	pending INT, -- The number of in progress registrations using this token. NULL if total_uses is NULL.
