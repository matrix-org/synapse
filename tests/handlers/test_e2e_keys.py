...
class E2eKeysHandlerTestCase(unittest.TestCase):
    ...
    test_replace_master_key.skip = "Disabled waiting on #https://github.com/matrix-org/synapse/pull/6486"
    ...
    test_upload_signatures.skip = "Disabled waiting on #https://github.com/matrix-org/synapse/pull/6486"
