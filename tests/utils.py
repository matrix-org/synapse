...
def default_config(name):
    ...
    config.client_rc = {}
    config.client_rc.messages.per_second = 10000
    config.client_rc.messages.burst_count = 10000
    config.client_rc.registration.per_second = 10000
    config.client_rc.registration.burst_count = 10000
    config.client_rc.login.address.per_second = 10000
    config.client_rc.login.address.burst_count = 10000
    config.client_rc.login.account.per_second = 10000
    config.client_rc.login.account.burst_count = 10000
