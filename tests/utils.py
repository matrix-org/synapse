...
def default_config(name):
    ...
    config.rc_registration_request_burst_count = 10000
    config.rc_registration_requests_per_second = 10000
    config.rc_login_requests_per_address_per_second = 10000
    config.rc_login_request_per_address_burst_count = 10000
    config.rc_login_requests_per_user_per_second = 10000
    config.rc_login_request_per_user_burst_count = 10000
