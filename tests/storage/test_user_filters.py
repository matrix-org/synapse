...
class UserFiltersStoreTestCase(unittest.HomeserverTestCase):
    ...
    def test_upgrade_function(self) -> None:
        ...
        # get the upgrade function and run the upgrade on the db we just prepared
        module_name = "synapse.storage.v78_0_2_validate_and_update_user_filters"
        absolute_path = "../../synapse/storage/schema/main/delta/78/02_validate_and_update_user_filters.py"
