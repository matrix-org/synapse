...
class PartialCurrentStateTrackerTestCase(TestCase):
    ...
    def test_un_partial_state_race(self):
        ...
        async def is_room_got_partial_state(events):
            self.tracker.notify_un_partial_stated("room_id")
            return True

        self.mock_store.is_room_got_partial_state.side_effect = (
            is_room_got_partial_state
        )
