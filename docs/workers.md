...
federation traffic only goes through those instances. This allows you to set more strict
access controls (like a firewall) for all workers and only allow the
