...
Currently defaults to ["10"](https://spec.matrix.org/v1.4/rooms/v10/).

_Changed in Synapse X.Y:_ the default version room version was increased from [9](https://spec.matrix.org/v1.4/rooms/v9/) to [10](https://spec.matrix.org/v1.4/rooms/v10/).
